...
Website work on url https://covidwebfrontend.herokuapp.com/, production code for heroku is on [production](https://github.com/mzarejko/covid_web/tree/production)
